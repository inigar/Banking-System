...
public class LoginServlet extends HttpServlet
{
	public void service(HttpServletRequest req , HttpServletResponse res)throws IOException , ServletException
	{
		...
		HttpSession session=req.getSession();           //session tracking
		...
		try{
			...
			{
         				if(user.equals("ragini")&& password.equals("admin"))
						{
					     out.println("welcome " +user);
						...
						{
					     JOptionPane.showMessageDialog(null,"invalid username or password","Alert Message",JOptionPane.WARNING_MESSAGE);    //swing & javascript
